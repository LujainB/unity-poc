...
#ifndef KEYCSDK_SWIFT_H
#define KEYCSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KeyCSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class ASWebAuthenticationSession;

SWIFT_CLASS("_TtC7KeyCSDK14AuthPOCManager")
@interface AuthPOCManager : NSObject <ASWebAuthenticationPresentationContextProviding>
